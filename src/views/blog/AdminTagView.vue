...
const getTagList = () => {
  tagAdminListService(searchform.value)
    .then((data) => {
...
const add = () => {
  //api
  tagAddService(addForm.value.form)
    .then((data) => {
      changeAddFormVisable()
      getTagList()
    })
...
const update = () => {
  //api
  tagUpdateService(updateForm.value.form)
    .then((data) => {
      changeUpdateFormVisable()
      getTagList()
    })
  ...
  <div class="tagView">
      ...
      <el-row>
        ...
        >
          ...
          <el-form-item label="标签状态">
            <el-select v-model="searchform.status" placeholder="标签状态">
          ...
          <el-form-item>
            ...
            <el-button type="danger" plain @click="deletTag()">
              <el-icon>
    ...
    <div class="tableMain">
      ...
      >
        ...
        <!--标签名-->
        <el-table-column label="标签名" prop="name" align="center"></el-table-column>
        <!--标签状态-->
      ...
      <div class="dialog">
        ...
        <el-dialog title="添加" v-model="addForm.dialogFormVisible" widt="50%" align-center>
          <el-form :model="addForm.form" :label-width="addForm.formLabelWidth" :inline="false">
            <!--标签名-->
            <el-form-item label="标签名">
              <el-input v-model="addForm.form.name" placeholder="请输入标签名" />
            </el-form-item>
            <!--标签状态-->
            <el-form-item label="标签状态">
